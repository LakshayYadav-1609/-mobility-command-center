...
<style>
  ...
  .metric-label { font-size: 14px; color: #475569; text-transform: uppercase; letter-spacing: 0.05em; margin-top: 10px; }
  ...
  <div style="display:flex;align-items:center;gap:16px;">
    ...
    <div>
      ...
      <p style="color:#6366F1;margin:4px 0 0;font-size:14px;font-weight:500;">
        6 service tracks per assignee · Real-time visibility · Risk intelligence
      </p>
    </div>
  </div>
</div>
...
with f3:
    search = st.text_input("🔎 Search assignee")
    ...
    with st.expander(
        ...
        for i, stype in enumerate(SERVICE_TYPES):
            ...
            with cols[i]:
                if svc.empty:
                    ...
                    pct = {"Completed":100,"In Progress":60,
        ...
        <div class="risk-gauge">
          ...
          <div style="font-size:32px;font-weight:800;
                      color:{risk_color};min-width:72px;
